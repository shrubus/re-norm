...
test_data = [
    ...
    ("- 33.4", "- 33.4", "- 33.4"),
    ("- 33.4", "- 33.4", "- 33.4"),
    ("-\xa033.4", "-\xa033.4", "-\xa033.4"),
    ("1333.4", "1333.4", "1333.4"),
    ("1 333.4", "1 333.4", "1 333.4"),
    ("1'333.4", "1'333.4", "1'333.4"),
    ("1,333.4", "1,333.4", "1,333.4"),
    ("1 333.4", "1 333.4", "1 333.4"),
    ("1\xa0333.4", "1\xa0333.4", "1\xa0333.4"),
    ("- 1 333'222.4", "- 1 333'222.4", "- 1 333'222.4"),
    ("- 1 333'222", "- 1 333'222", "- 1 333'222"),
    ("222", "222", "222"),
    ...
    ("1.333.222.4", "1.333.222.4", "1.333.222.4"),
    ("1;333;222.4", "1;333;222.4", "1;333;222.4"),
    ("1_333_222.4", "1_333_222.4", "1_333_222.4"),
    ("1 333\xa0222.4", "1 333\xa0222.4", "1 333\xa0222.4"),
    ("-\xa01 333.4", "-\xa01 333.4", "-\xa01 333.4"),
    (".4", ".4", ".4"),
    ("-.4", "-.4", "-.4"),
    ("+.4", "+.4", "+.4"),
    ("  -   1  333   222   .4  ", "-   1  333   222   .4", "-   1  333   222   .4"),
    ("1  \xa0333.4", "1  \xa0333.4", "1  \xa0333.4"),
    ("1 333.4abc", "1 333.4", "1 333.4"),
    ("1 333.4'", "1 333.4", "1 333.4"),
    ("1.333.4", "1.333.4", "1.333.4"),
    ("1,333,4", "1,333,4", "1,333,4"),
    ("0", "0", "0"),
    ...
    ("1 333.4ab3.4", "1 333.4", "1 333.4"),
    ("1 333.4£", "1 333.4", "1 333.4"),
    ("$1 333.4", "1 333.4", "1 333.4"),
    # end with pontuation
    ("1 231,3,", "1 231,3", "1 231,3"),
    ("1 231.3.", "1 231.3", "1 231.3"),
    ("1 231.3;", "1 231.3", "1 231.3"),
    ("1 231.3-", "1 231.3", "1 231.3"),
    ("1 231.3_", "1 231.3", "1 231.3"),
    # ambiguous grouping
    ("1333'333.4", "1333'333.4", None),
    ("1,333,4 5", "1,333,4 5", None),
    ("0,0.0.0'0_0", "0,0.0.0'0_0", None),
    ("0,0.0a0'0_0", "0,0.0", None),
    ("1'22'33,4", "1'22'33,4", None),
    ("1 22 33,4", "1 22 33,4", None),
    # single symbols
    (" - ", None, None),
    (" + ", None, None),
...
@pytest.mark.parametrize("text, raw, filtered", test_data)
def test_num_default_spec_capture(text, raw, filtered):
    result = rn.Num()._select_num_candidate(raw)
