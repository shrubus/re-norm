...
default_num_data = [
    ("33.4", r"({@0})", rn.Num(), ("33.4",)),
    ("-33.4", r"({@0})", rn.Num(), ("-33.4",)),
    ("- 33.4", r"({@0})", rn.Num(), ("-33.4",)),
    ("-  33.4", r"({@0})", rn.Num(), ("33.4",)),  # danger/ambiguity
    (f"-{nbsp[0]}33.4", r"({@0})", rn.Num(), ("-33.4",)),
    (f"-{nbsp[1]}33.4", r"({@0})", rn.Num(), ("-33.4",)),
    ("1333.4", r"({@0})", rn.Num(), ("1333.4",)),
    ("1 333.4", r"({@0})", rn.Num(), ("1333.4",)),
    ("1'333.4", r"({@0})", rn.Num(), ("1333.4",)),
    ("1,333.4", r"({@0})", rn.Num(), ("1333.4",)),
    (f"1{nbsp[0]}333.4", r"({@0})", rn.Num(), ("1333.4",)),
    (f"1{nbsp[1]}333.4", r"({@0})", rn.Num(), ("1333.4",)),
    ("- 1 333'222.4", r"({@0})", rn.Num(), ("-1333222.4",)),
    ("- 1 333'222", r"({@0})", rn.Num(), ("-1333222",)),
    ("222", r"({@0})", rn.Num(), ("222",)),
]


@pytest.mark.parametrize("text, pat, spec, expected", default_num_data)
def test_default_num_spec_capture(text, pat, spec, expected):
